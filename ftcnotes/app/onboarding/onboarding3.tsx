    ...
    <View style={styles.container}>
      ...
      <View style={styles.titleWrapper}>
        <View style={styles.highlightWrapper}>
          ...
          <Text style={[styles.title, { color: theme.textColor }]}>3.) Create Teams</Text>
        </View>
      </View>

      {/* Subtitle */}
      <Text style={styles.subtitle}>
        Easily add info for every team{'\n'}at your event to find the best{'\n'}alliance partners
      </Text>
      ...
      <View style={styles.buttonRow}>
        ...
        <TouchableOpacity onPress={goFinish} style={styles.continueButton} activeOpacity={0.85}>
